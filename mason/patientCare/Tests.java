...
public class Tests {
	...
	for(int policy = 0; policy < policies.length; policy++) {
		...
		care.startObserver(false, false, true, false, false, true, false, false, false, false, false, false, false, false);
...
//				}
	...
	void check_observer_visitsCounter() {
		...
		care.startObserver(false, false, false, false, false, false, true, false, false, false, false, false, false, false);
		care.start();
		int sum;
