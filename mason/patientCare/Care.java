...
public class Care extends SimState {
	...
	public void startObserver(boolean obsH, boolean obsN, boolean obsC, 
			...
			boolean disease, boolean expNoise, boolean instExp, boolean delta) {
		observer=new ObserveCare(this, OBS_PERIOD, obsH, obsN, obsC, obsT, obsE, obsB, simpleC, simpleE, simpleB, disease, expNoise, instExp, delta);
